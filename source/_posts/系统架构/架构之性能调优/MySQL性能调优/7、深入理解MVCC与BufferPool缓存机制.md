---
title: 7、深入理解MVCC与BufferPool缓存机制
date: 2023-06-12 09:38:14
categories:
    - 系统架构
    - 架构之性能调优
    - MySQL性能调优
...
undo日志版本链是指**一行数据**被多个事务依次修改过后，在每个事务修改完后，Mysql会保留修改前的数据undo回滚日志，并且用两个隐藏字段trx_id和roll_pointer把这些undo日志串联起来形成一个历史记录版本链(见下图，需参考视频里的例子理解)

​    ![0](7%E3%80%81%E6%B7%B1%E5%85%A5%E7%90%86%E8%A7%A3MVCC%E4%B8%8EBufferPool%E7%BC%93%E5%AD%98%E6%9C%BA%E5%88%B6/99285-1686982703090106)
...
1. 如果 row 的 trx_id 落在绿色部分( trx_id<min_id),表示这个版本是已经提交的事务生成的，这个数据是可见的
...
​    ![0](7%E3%80%81%E6%B7%B1%E5%85%A5%E7%90%86%E8%A7%A3MVCC%E4%B8%8EBufferPool%E7%BC%93%E5%AD%98%E6%9C%BA%E5%88%B6/99001-1686982703091108)
